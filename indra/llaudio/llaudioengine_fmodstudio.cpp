...
// (MB) rename all uses of F_CALLBACK to F_CALL per FMOD documentation

FMOD_RESULT F_CALL systemCallback(FMOD_SYSTEM* system, FMOD_SYSTEM_CALLBACK_TYPE type, void* commanddata1, void* commanddata2,
                                 void* userdata)
{
...
FMOD_RESULT F_CALL windCallback(FMOD_DSP_STATE* dsp_state, float* inbuffer, float* outbuffer, unsigned int length, int inchannels,
                                int* outchannels)
{
