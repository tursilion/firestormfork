...
Confirm things are installed properly so far by opening a Windows CMD terminal and enter:
...
But more likely, the first autobuild will dump you into a command prompt because of changes to how programs execute. If that
happens (ie: you see "Microsfot Windows [Version..." etc):
